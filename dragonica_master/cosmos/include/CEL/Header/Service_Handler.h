...
namespace CEL
{
	...
	class Service_Handler//! 가능한한 최소한의 네트웍 기능을 가진다.
...
//		typedef typename ACE_Recursive_Thread_Mutex MUTEX;
	...
	public:
		...
		typedef typename Service_Handler< T_SESSION >	THIS_TYPE;
	...
	public:
		Service_Handler(INIT_CORE_DESC const& kInitInfo = INIT_CORE_DESC());
	...
	protected:
		...
		PACKET_TYPE m_kRecvPacketBuf;
	};

#include "Service_Handler.inl"
}; 