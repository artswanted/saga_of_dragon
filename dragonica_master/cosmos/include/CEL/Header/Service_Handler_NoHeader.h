...
namespace CEL
{
	...
	class Service_Handler_NoHeader//! 가능한한 최소한의 네트웍 기능을 가진다.
	...
	public:
		...
		typedef typename Service_Handler_NoHeader< T_SESSION >					THIS_TYPE;

		typedef typename T_SESSION::PACKET_TYPE								PACKET_TYPE;
		typedef ACE_Message_Block MSG_BLK;
		static const DWORD MAX_BODY_SIZE = 600000;
	...
	public:
		Service_Handler_NoHeader(INIT_CORE_DESC const& kInitInfo = INIT_CORE_DESC());
		virtual ~Service_Handler_NoHeader(void);
...
#include "Service_Handler_NoHeader.inl"
}; 