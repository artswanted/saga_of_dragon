#ifndef MAP_MAPSERVER_ACTION_AI_PGAIACTHIDE_H
#define MAP_MAPSERVER_ACTION_AI_PGAIACTHIDE_H
...
#define AI_HIDE_DELAY_TIME 1000

#endif // MAP_MAPSERVER_ACTION_AI_PGAIACTHIDE_H