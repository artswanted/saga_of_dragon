#ifndef MAP_MAPSERVER_ACTION_AI_PGAIACTOPENING_H
#define MAP_MAPSERVER_ACTION_AI_PGAIACTOPENING_H

class PgAIActOpening
{
public:
	PgAIActOpening() {};
	~PgAIActOpening() {};
...
#endif // MAP_MAPSERVER_ACTION_AI_PGAIACTOPENING_H