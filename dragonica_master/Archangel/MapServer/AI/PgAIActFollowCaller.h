#ifndef MAP_MAPSERVER_ACTION_AI_PGAIACTFOLLOWCALLER_H
#define MAP_MAPSERVER_ACTION_AI_PGAIACTFOLLOWCALLER_H

class PgAIActFollowCaller
{
public:
	PgAIActFollowCaller() {};
	~PgAIActFollowCaller() {};
...
#endif // MAP_MAPSERVER_ACTION_AI_PgAIActFollowCaller_H