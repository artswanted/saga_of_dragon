#ifndef MAP_MAPSERVER_ACTION_AI_PGAIACTWAITCT_H
#define MAP_MAPSERVER_ACTION_AI_PGAIACTWAITCT_H


class PgAIWaitCoolTime
{
public:
	PgAIWaitCoolTime() {};
	~PgAIWaitCoolTime() {};
...
#endif // MAP_MAPSERVER_ACTION_AI_PGAIACTWAITCT_H