#ifndef MAP_MAPSERVER_ACTION_AI_PGAIACTCALLHELP_H
#define MAP_MAPSERVER_ACTION_AI_PGAIACTCALLHELP_H

class PgAIActCallHelp
{
public:
	PgAIActCallHelp() {};
	~PgAIActCallHelp() {};
...
#endif // MAP_MAPSERVER_ACTION_AI_PGAIACTCALLHELP_H