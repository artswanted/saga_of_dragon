#ifndef MAP_MAPSERVER_PUBLICMAP_PVPWAR_MODE_PGPVPTYPE_WINNERSMATCH_H
#define MAP_MAPSERVER_PUBLICMAP_PVPWAR_MODE_PGPVPTYPE_WINNERSMATCH_H

#include "PgPvPType_DeathMatch.h"

class PgPvPType_WinnersMatch 
...
public:
	PgPvPType_WinnersMatch ();
	virtual ~PgPvPType_WinnersMatch ();
...
#endif // MAP_MAPSERVER_PUBLICMAP_PVPWAR_MODE_PGPVPTYPE_WINNERSMATCH_H