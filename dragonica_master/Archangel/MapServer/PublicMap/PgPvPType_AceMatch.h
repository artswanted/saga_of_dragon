#ifndef MAP_MAPSERVER_PUBILCMAP_PVPWAR_MODE_PGPVPTYPE_ACEMATCH_H
#define MAP_MAPSERVER_PUBILCMAP_PVPWAR_MODE_PGPVPTYPE_ACEMATCH_H

#include "PgPvPType_DeathMatch.h"

class PgPvPType_AceMatch 
...
public:
	...
	virtual bool CheckEntryWait(DWORD const dwElapsedTime);
	virtual bool SelectEntry(int const iTeam, BM::GUID const &rkCharGuid);
...
protected:
	...
	bool							m_bEndRound;
	int								m_iRoundWinTeam;
	DWORD						m_dwWaitBeginTime;
};

#endif // MAP_MAPSERVER_PUBILCMAP_PVPWAR_MODE_PGPVPTYPE_ACEMATCH_H