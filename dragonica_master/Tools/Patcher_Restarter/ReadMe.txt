================================================================================
    MFC 라이브러리 : PatcherPatch 프로젝트 개요
===============================================================================

응용 프로그램 마법사에서 이 PatcherPatch 응용 프로그램을 
만들었습니다. 이 응용 프로그램은 MFC의 기본 사용법을 보여 줄 뿐만 아니라 응용 프로그램
작성을 위한 기본 구조를 제공합니다.

이 파일에는 PatcherPatch 응용 프로그램을 구성하는 각 파일에 대한
요약 설명이 포함되어 있습니다.
...
PatcherPatch.h
    ...
    헤더(Resource.h 포함)가 들어 있고 CPatcherPatchApp 응용 프로그램
    클래스를 선언합니다.

PatcherPatch.cpp
    응용 프로그램 클래스 CPatcherPatchApp이(가) 들어 있는 기본 응용 프로그램
    소스 파일입니다.
...
res\PatcherPatch.ico
    응용 프로그램의 아이콘으로 사용되는 아이콘 파일입니다. 이 아이콘은
    주 리소스 파일인 PatcherPatch.rc에 의해 포함됩니다.

res\PatcherPatch.rc2
...
PatcherPatchDlg.h, PatcherPatchDlg.cpp ? 대화 상자
    이 파일에는 CPatcherPatchDlg 클래스가 들어 있습니다. 이 클래스는
    응용 프로그램의 주 대화 상자 동작을 정의합니다. 대화 상자의 템플릿은
    Microsoft Visual C++에서 편집할 수 있는 PatcherPatch.rc에 있습니다.
...
StdAfx.h, StdAfx.cpp
    이 파일은 미리 컴파일된 헤더 파일(PCH)인 PatcherPatch.pch와
...
[Patcher][Restarter]
 - PatcherPatch.exe 파일이 없을 경우의 패치를 진행하기 위한 리스타터
   패쳐를 종료하고, 상위 폴더의 패쳐를 실행함.