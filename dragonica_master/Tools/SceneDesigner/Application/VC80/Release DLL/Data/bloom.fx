...
float SceneIntensity : GLOBAL = 0.5f;
float GlowIntensity : GLOBAL = 0.5f;

float HighlightThreshold : GLOBAL = 0.9f;

float HighlightIntensity : GLOBAL = 0.5f;
...
static const half weights7_Central[7] = {
	0.0,
	0.0,
	0.2,
	0.6,
