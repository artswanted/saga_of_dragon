function PROJECTILE_BANANA_STAR_OnCollision(kProjectile,kCollideActor,kTargets)
	return	PROJECTILE_ARROW_OnCollision(kProjectile,kCollideActor,kTargets);
end

function PROJECTILE_BANANA_STAR_OnArrivedAtTarget(kProjectile)
...
function PROJECTILE_BANANA_STAR_OnTargetListModified(kProjectile)
