function PROJECTILE_HOMMING_MISSILE_OnCollision(kProjectile,kCollideActor,kTargets)
	return	PROJECTILE_ARROW_OnCollision(kProjectile,kCollideActor,kTargets);
end

function PROJECTILE_HOMMING_MISSILE_OnArrivedAtTarget(kProjectile)
...
function PROJECTILE_HOMMING_MISSILE_OnTargetListModified(kProjectile)
	PROJECTILE_HOMMING_MISSILE_OnArrivedAtTarget(kProjectile)
end