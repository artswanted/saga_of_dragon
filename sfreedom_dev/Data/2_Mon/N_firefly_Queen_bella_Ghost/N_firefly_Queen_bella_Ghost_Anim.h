...
#ifndef N_FIREFLY_QUEEN_BELLA_GHOST_ANIM_H__
#define N_FIREFLY_QUEEN_BELLA_GHOST_ANIM_H__

namespace N_firefly_Queen_bella_Ghost_Anim
{
    enum
    {
...
#endif  // #ifndef N_FIREFLY_QUEEN_BELLA_GHOST_ANIM_H__
