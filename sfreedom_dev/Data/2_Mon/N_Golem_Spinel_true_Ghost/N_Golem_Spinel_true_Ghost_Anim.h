...
#ifndef N_GOLEM_SPINEL_TRUE_GHOST_ANIM_H__
#define N_GOLEM_SPINEL_TRUE_GHOST_ANIM_H__

namespace N_Golem_Spinel_true_Ghost_Anim
{
    enum
    {
...
#endif  // #ifndef N_GOLEM_SPINEL_TRUE_GHOST_ANIM_H__
