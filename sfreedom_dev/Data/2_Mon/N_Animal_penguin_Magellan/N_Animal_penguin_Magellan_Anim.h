...
#ifndef N_ANIMAL_PENGUIN_MAGELLAN_ANIM_H__
#define N_ANIMAL_PENGUIN_MAGELLAN_ANIM_H__

namespace N_Animal_penguin_Magellan_Anim
{
    enum
    {
...
#endif  // #ifndef N_ANIMAL_PENGUIN_MAGELLAN_ANIM_H__
