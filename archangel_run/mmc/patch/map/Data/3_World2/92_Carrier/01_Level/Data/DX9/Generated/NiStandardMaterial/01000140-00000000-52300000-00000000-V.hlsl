#line 2 "D:\test\archangel_run\mmc\patch\map\Data\3_World2\92_Carrier\01_Level\Data\DX9\\Generated\\NiStandardMaterial\01000140-00000000-52300000-00000000-V.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(0), bool(true), float(1.0), 
        ...
        g_DirWorldDirection2, g_MaterialPower, AmbientAccumOut_CallOut8, 
    ...
    ComputeShadingCoefficients(g_MaterialEmissive, Color_CallOut2, 
        g_MaterialAmbient, g_MaterialSpecular, SpecularAccumOut_CallOut9, 
        DiffuseAccumOut_CallOut9, AmbientAccumOut_CallOut9, bool(false), 
        Diffuse_CallOut10, Out.SpecularAccum);

	// Function call #11
    CompositeFinalRGBAColor(Diffuse_CallOut10, Opacity_CallOut2, 
        Out.DiffuseAccum);
