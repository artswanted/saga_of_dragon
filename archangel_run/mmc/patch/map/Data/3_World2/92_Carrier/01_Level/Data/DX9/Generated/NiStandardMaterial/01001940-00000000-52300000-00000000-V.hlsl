#line 2 "D:\test\archangel_run\mmc\patch\map\Data\3_World2\92_Carrier\01_Level\Data\DX9\\Generated\\NiStandardMaterial\01001940-00000000-52300000-00000000-V.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    WorldReflect(WorldNrm_CallOut3, WorldViewVector_CallOut5, bool(true), 
        WorldReflect_CallOut7);

	// Function call #8
    float3 VectorOut_CallOut8;
    NormalizeFloat3(WorldReflect_CallOut7, VectorOut_CallOut8);
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(0), bool(true), float(1.0), 
        ...
        float3(0.0, 0.0, 0.0), float3(0.0, 0.0, 0.0), AmbientAccumOut_CallOut9, 
        DiffuseAccumOut_CallOut9, SpecularAccumOut_CallOut9);

	// Function call #10
    ProjectTextureCoordinates(VectorOut_CallOut8, 
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(0), bool(true), float(1.0), 
        ...
        g_DirWorldDirection, g_MaterialPower, AmbientAccumOut_CallOut9, 
        DiffuseAccumOut_CallOut9, SpecularAccumOut_CallOut9, 
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(0), bool(true), float(1.0), 
        ...
        g_DirWorldDirection2, g_MaterialPower, AmbientAccumOut_CallOut11, 
