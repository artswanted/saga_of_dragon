#line 2 "D:\test\archangel_run\mmc\patch\map\Data\3_World2\92_Carrier\01_Level\Data\DX9\\Generated\\NiStandardMaterial\03000101-00000800-00000000-00090000-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    TextureRGBSample(In.UVSet1, EnvironmentMap, bool(false), ColorOut_CallOut2);
    ...
    AddFloat3(ColorOut_CallOut2, In.SpecularAccum, Output_CallOut6);

	// Function call #7
    float3 OutputColor_CallOut7;
    CompositeFinalRGBColor(Output_CallOut4, Output_CallOut6, 
        OutputColor_CallOut7);

	// Function call #8
    CompositeFinalRGBAColor(OutputColor_CallOut7, Output_CallOut5, Out.Color0);
