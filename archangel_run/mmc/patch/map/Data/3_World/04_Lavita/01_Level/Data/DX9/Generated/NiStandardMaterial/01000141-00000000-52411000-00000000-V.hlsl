#line 2 "D:\test\archangel_run\mmc\patch\map\Data\3_World\04_Lavita\01_Level\Data\DX9\\Generated\\NiStandardMaterial\01000141-00000000-52411000-00000000-V.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(2), bool(true), float(1.0), 
        ...
        AmbientAccumOut_CallOut11, DiffuseAccumOut_CallOut11, 
        SpecularAccumOut_CallOut11, AmbientAccumOut_CallOut12, 
    ...
    ComputeShadingCoefficients(g_MaterialEmissive, Color_CallOut2, 
        g_MaterialAmbient, g_MaterialSpecular, SpecularAccumOut_CallOut12, 
        DiffuseAccumOut_CallOut12, AmbientAccumOut_CallOut12, bool(false), 
        Diffuse_CallOut13, Out.SpecularAccum);

	// Function call #14
    CompositeFinalRGBAColor(Diffuse_CallOut13, Opacity_CallOut2, 
        Out.DiffuseAccum);
