#line 2 "D:\test\archangel_run\mmc\patch\map\Data\3_World\04_Lavita\01_Level\Data\DX9\\Generated\\NiStandardMaterial\00000440-00000000-52701000-00000000-V.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
float4 g_DirAmbient4;
float4 g_DirDiffuse4;
float4 g_DirSpecular4;
float4 g_DirWorldPosition4;
float4 g_DirWorldDirection4;
float4 g_DirAmbient5;
float4 g_DirDiffuse5;
float4 g_DirSpecular5;
float4 g_DirWorldPosition5;
float4 g_DirWorldDirection5;
float4 g_DirAmbient6;
float4 g_DirDiffuse6;
float4 g_DirSpecular6;
float4 g_DirWorldPosition6;
float4 g_DirWorldDirection6;
float4 g_FogDensity;
float4 g_FogNearFar;
//---------------------------------------------------------------------------
// Functions:
...
Output Main(Input In)
{
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(0), bool(false), 
        float(1.0), float3(0.0, 0.0, 0.0), g_DirWorldPosition2, g_DirAmbient2, 
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(0), bool(false), 
        float(1.0), float3(0.0, 0.0, 0.0), g_DirWorldPosition3, g_DirAmbient3, 
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(0), bool(false), 
        float(1.0), float3(0.0, 0.0, 0.0), g_DirWorldPosition4, g_DirAmbient4, 
        g_DirDiffuse4, g_DirSpecular4, float3(0.0, 1.0, 0.0), 
        float3(-1.0, -1.0, 0.0), g_DirWorldDirection4, 
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(0), bool(false), 
        float(1.0), float3(0.0, 0.0, 0.0), g_DirWorldPosition5, g_DirAmbient5, 
        g_DirDiffuse5, g_DirSpecular5, float3(0.0, 1.0, 0.0), 
        float3(-1.0, -1.0, 0.0), g_DirWorldDirection5, 
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(0), bool(false), 
        float(1.0), float3(0.0, 0.0, 0.0), g_DirWorldPosition6, g_DirAmbient6, 
        g_DirDiffuse6, g_DirSpecular6, float3(0.0, 1.0, 0.0), 
        float3(-1.0, -1.0, 0.0), g_DirWorldDirection6, 
