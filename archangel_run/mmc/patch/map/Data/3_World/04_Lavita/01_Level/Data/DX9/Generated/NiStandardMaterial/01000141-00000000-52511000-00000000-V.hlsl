#line 2 "D:\test\archangel_run\mmc\patch\map\Data\3_World\04_Lavita\01_Level\Data\DX9\\Generated\\NiStandardMaterial\01000141-00000000-52511000-00000000-V.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
    ...
    TransformNormal(In.Normal, SkinBoneTransform_CallOut0, WorldNrm_CallOut3);
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(0), bool(true), float(1.0), 
        ...
        g_DirWorldDirection, g_MaterialPower, AmbientAccumOut_CallOut8, 
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(0), bool(true), float(1.0), 
        VectorOut_CallOut6, g_DirWorldPosition2, g_DirAmbient2, g_DirDiffuse2, 
        g_DirSpecular2, float3(0.0, 1.0, 0.0), float3(-1.0, -1.0, 0.0), 
        g_DirWorldDirection2, g_MaterialPower, AmbientAccumOut_CallOut9, 
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(0), bool(true), float(1.0), 
        VectorOut_CallOut6, g_DirWorldPosition3, g_DirAmbient3, g_DirDiffuse3, 
        g_DirSpecular3, float3(0.0, 1.0, 0.0), float3(-1.0, -1.0, 0.0), 
        g_DirWorldDirection3, g_MaterialPower, AmbientAccumOut_CallOut10, 
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(0), bool(true), float(1.0), 
        VectorOut_CallOut6, g_DirWorldPosition4, g_DirAmbient4, g_DirDiffuse4, 
        g_DirSpecular4, float3(0.0, 1.0, 0.0), float3(-1.0, -1.0, 0.0), 
        g_DirWorldDirection4, g_MaterialPower, AmbientAccumOut_CallOut11, 
    ...
    ComputeShadingCoefficients(g_MaterialEmissive, Color_CallOut2, 
        g_MaterialAmbient, g_MaterialSpecular, SpecularAccumOut_CallOut13, 
        DiffuseAccumOut_CallOut13, AmbientAccumOut_CallOut13, bool(false), 
        Diffuse_CallOut14, Out.SpecularAccum);

	// Function call #15
    CompositeFinalRGBAColor(Diffuse_CallOut14, Opacity_CallOut2, 
        Out.DiffuseAccum);
