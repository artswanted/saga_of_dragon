#line 2 "D:\test\archangel_run\mmc\patch\map\Data\3_World\93_EventMap\200_collective_farm\Data\DX9\\Generated\\NiStandardMaterial\01000040-00000000-52005000-00000000-V.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
	...
	// Function call #10
    float3 Diffuse_CallOut10;
    float3 Specular_CallOut10;
    ComputeShadingCoefficients(g_MaterialEmissive, Color_CallOut4, 
        ...
        Diffuse_CallOut10, Specular_CallOut10);

	// Function call #11
    CompositeFinalRGBAColor(Diffuse_CallOut10, Opacity_CallOut4, 
        Out.DiffuseAccum);
