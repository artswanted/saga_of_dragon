#line 2 "D:\test\archangel_run\mmc\patch\map\Data\3_World\93_EventMap\200_collective_farm\Data\DX9\\Generated\\NiStandardMaterial\01000040-00000000-53007000-00000000-V.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
Output Main(Input In)
{
	...
	// Function call #12
    float3 Diffuse_CallOut12;
    float3 Specular_CallOut12;
    ComputeShadingCoefficients(g_MaterialEmissive, Color_CallOut4, 
        g_MaterialAmbient, float3(1.0, 1.0, 1.0), float3(0.0, 0.0, 0.0), 
        DiffuseAccumOut_CallOut11, AmbientAccumOut_CallOut11, bool(false), 
        Diffuse_CallOut12, Specular_CallOut12);

	// Function call #13
    CompositeFinalRGBAColor(Diffuse_CallOut12, Opacity_CallOut4, 
        Out.DiffuseAccum);
