#line 2 "D:\test\archangel_run\mmc\patch\map\Data\3_World\93_EventMap\200_collective_farm\Data\DX9\\Generated\\NiStandardMaterial\00800001-00000800-00000000-00080000-P.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
    ...
    out float3 FoggedColor)
{
      ...
      FoggedColor = lerp(UnfoggedColor,FoggedColor,FogAlpha);

      //FoggedColor = UnfoggedColor + ( (FogColor + (UnfoggedColor - FogColor)*FogAmount ) - UnfoggedColor ) * FogAlpha;
...
Output Main(Input In)
{
    ...
    ApplyFog(OutputColor_CallOut2, g_FogColor, In.FogDepth, g_FogAlpha, 
        FoggedColor_CallOut3);

	// Function call #4
    CompositeFinalRGBAColor(FoggedColor_CallOut3, Opacity_CallOut0, Out.Color0);
