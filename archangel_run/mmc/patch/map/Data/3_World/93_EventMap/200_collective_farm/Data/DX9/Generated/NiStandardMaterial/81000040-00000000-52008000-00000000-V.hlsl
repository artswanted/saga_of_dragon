#line 2 "D:\test\archangel_run\mmc\patch\map\Data\3_World\93_EventMap\200_collective_farm\Data\DX9\\Generated\\NiStandardMaterial\81000040-00000000-52008000-00000000-V.hlsl"
//---------------------------------------------------------------------------
// Constant variables:
//---------------------------------------------------------------------------
...
float4 g_PointAmbient3;
float4 g_PointDiffuse3;
float4 g_PointSpecular3;
float4 g_PointWorldPosition3;
float4 g_PointAttenuation3;
float4 g_PointAmbient4;
float4 g_PointDiffuse4;
float4 g_PointSpecular4;
float4 g_PointWorldPosition4;
float4 g_PointAttenuation4;
float4 g_PointAmbient5;
float4 g_PointDiffuse5;
float4 g_PointSpecular5;
float4 g_PointWorldPosition5;
float4 g_PointAttenuation5;
float4 g_PointAmbient6;
float4 g_PointDiffuse6;
float4 g_PointSpecular6;
float4 g_PointWorldPosition6;
float4 g_PointAttenuation6;
float4 g_PointAmbient7;
float4 g_PointDiffuse7;
float4 g_PointSpecular7;
float4 g_PointWorldPosition7;
float4 g_PointAttenuation7;
...
Output Main(Input In)
{
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(1), bool(false), 
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(1), bool(false), 
        float(1.0), float3(0.0, 0.0, 0.0), g_PointWorldPosition3, 
        g_PointAmbient3, g_PointDiffuse3, g_PointSpecular3, g_PointAttenuation3, 
        float3(-1.0, -1.0, 0.0), float3(1.0, 0.0, 0.0), 
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(1), bool(false), 
        float(1.0), float3(0.0, 0.0, 0.0), g_PointWorldPosition4, 
        g_PointAmbient4, g_PointDiffuse4, g_PointSpecular4, g_PointAttenuation4, 
        float3(-1.0, -1.0, 0.0), float3(1.0, 0.0, 0.0), 
        float4(1.0, 1.0, 1.0, 1.0), AmbientAccumOut_CallOut9, 
        DiffuseAccumOut_CallOut9, float3(0.0, 0.0, 0.0), 
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(1), bool(false), 
        float(1.0), float3(0.0, 0.0, 0.0), g_PointWorldPosition5, 
        g_PointAmbient5, g_PointDiffuse5, g_PointSpecular5, g_PointAttenuation5, 
        float3(-1.0, -1.0, 0.0), float3(1.0, 0.0, 0.0), 
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(1), bool(false), 
        float(1.0), float3(0.0, 0.0, 0.0), g_PointWorldPosition6, 
        g_PointAmbient6, g_PointDiffuse6, g_PointSpecular6, g_PointAttenuation6, 
        float3(-1.0, -1.0, 0.0), float3(1.0, 0.0, 0.0), 
    ...
    Light(WorldPos_CallOut0, VectorOut_CallOut4, int(1), bool(false), 
        float(1.0), float3(0.0, 0.0, 0.0), g_PointWorldPosition7, 
        g_PointAmbient7, g_PointDiffuse7, g_PointSpecular7, g_PointAttenuation7, 
        float3(-1.0, -1.0, 0.0), float3(1.0, 0.0, 0.0), 
	...
	// Function call #15
    CompositeFinalRGBAColor(Diffuse_CallOut14, Opacity_CallOut5, 
        Out.DiffuseAccum);
