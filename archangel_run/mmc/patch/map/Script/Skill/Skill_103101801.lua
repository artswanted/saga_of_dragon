...
-- 메이지 더블샷 패시브
function Skill_Passive103101801(unit, skillno, actarg)
	return 0
end

function Skill_PCheck103101801(caster, skillno, actarg)
	return 0
end

function Skill_Begin103101801(caster, kSkillDef, actarg)
end

function Skill_End103101801(caster, kSkillDef, actarg)
end
