...
-- 레인저 공중 5연사 패시브: ) : Level 1 PASSIVE
function Skill_Passive110002401(unit, skillno, actarg)
	return 0
end

function Skill_PCheck110002401(caster, skillno, actarg)
	return 0
end

function Skill_Begin110002401(caster, kSkillDef, actarg)
end

function Skill_End110002401(caster, kSkillDef, actarg)
end
