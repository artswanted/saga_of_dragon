...
-- 전사 내려찍기 패시브 스킬
function Skill_Passive101102401(unit, skillno, actarg)
	return 0
end

function Skill_PCheck101102401(caster, skillno, actarg)
	return 0
end

function Skill_Begin101102401(caster, kSkillDef, actarg)
end

function Skill_End101102401(caster, kSkillDef, actarg)
end
