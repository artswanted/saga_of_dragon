...
-- 전사 띄우기 패시브 스킬
function Skill_Passive101102101(unit, skillno, actarg)
	return 0
end

function Skill_PCheck101102101(caster, skillno, actarg)
	return 0
end

function Skill_Begin101102101(caster, kSkillDef, actarg)
end

function Skill_End101102101(caster, kSkillDef, actarg)
