...
-- 기사 공중대쉬 강타 패시브
function Skill_Passive101102901(unit, skillno, actarg)
	return 0
end

function Skill_PCheck101102901(caster, skillno, actarg)
	return 0
end

function Skill_Begin101102901(caster, kSkillDef, actarg)
end

function Skill_End101102901(caster, kSkillDef, actarg)
end
