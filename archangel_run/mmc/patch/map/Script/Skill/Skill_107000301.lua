...
function Skill_Begin107000301(caster, skillnum, iStatus,arg)
	return Skill_BeginDefault(caster, skillnum, iStatus,arg)
end

function Skill_Fire107000301(caster, kTargetArray, skillnum, result, arg)
	--local bReturn = GetSkillResult107000301(caster, kTargetArray, skillnum, result)

	local kSkillDef = GetSkillDef(skillnum)
	if kSkillDef:IsNil() then
		InfoLog(5, "Skill_Fire107000301....SkillDef is NIl" ..skillnum)
		return -1
	end
	
	local iMin = caster:GetAbil(AT_C_MAGIC_ATTACK_MIN)
	local iPower = iMin + RAND(caster:GetAbil(AT_C_MAGIC_ATTACK_MAX) - iMin + 1)
	InfoLog(9, "Skill_Fire107000301 iPower=" .. iPower)
	...
	InfoLog(9, "Skill_Fire107000301 HealPower=" .. iPower)
...
function Skill_Fail107000301(caster, kTargetArray, skillnum, result, arg)
	return false
end
