...
-- 법사 공중콤보 1타 패시브 스킬
function Skill_Passive103101401(unit, skillno, actarg)
	return 0
end

function Skill_PCheck103101401(caster, skillno, actarg)
	return 0
end

function Skill_Begin103101401(caster, kSkillDef, actarg)
end

function Skill_End103101401(caster, kSkillDef, actarg)
end
