...
-- 전사 2차전직 공중콤보 조작3타 패시브
function Skill_Passive101102801(unit, skillno, actarg)
	return 0
end

function Skill_PCheck101102801(caster, skillno, actarg)
	return 0
end

function Skill_Begin101102801(caster, kSkillDef, actarg)
end

function Skill_End101102801(caster, kSkillDef, actarg)
end
