...
-- 암살자 사이드대쉬 어택 패시브
function Skill_Passive103202301(unit, skillno, actarg)
	return 0
end

function Skill_PCheck103202301(caster, skillno, actarg)
	return 0
end

function Skill_Begin103202301(caster, kSkillDef, actarg)
end

function Skill_End103202301(caster, kSkillDef, actarg)
end
