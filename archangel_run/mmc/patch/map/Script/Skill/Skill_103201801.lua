...
-- 도둑 띄우기 패시브
function Skill_Passive103201801(unit, skillno, actarg)
	return 0
end

function Skill_PCheck103201801(caster, skillno, actarg)
	return 0
end

function Skill_Begin103201801(caster, kSkillDef, actarg)
end

function Skill_End103201801(caster, kSkillDef, actarg)
end
