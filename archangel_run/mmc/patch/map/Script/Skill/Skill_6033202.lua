...
function Skill_Begin6033202(caster, skillnum, iStatus,arg,kTailPacket)
	...
	local kCasterPos = caster:GetPos()
	local firstPos = kCasterPos:Add(Point3(60,60,60))
	local secondPos = kCasterPos:Subtract(Point3(60,60,60))
	...
	kTailPacket:PushInt(1)
	
	return true
--	return Skill_BeginDefault(caster, skillnum, iStatus,arg)
end

function Skill_Fire6033202(caster, kTargetArray, skillnum, result, arg)
...
function Skill_CanFire6033202(caster, kTargetArray, skillnum, actarg)
	return true
end

function Skill_CanReserve6033202(caster, kTargetArray, skillnum, actarg)
	return Skill_CanReserveDefault(caster, kTargetArray, skillnum, actarg)
end

function Skill_Fail6033202(caster, kTargetArray, skillnum, result, arg)
	return false
end
