...
-- 광대 슬라이딩 태클 패시브
function Skill_Passive103202101(unit, skillno, actarg)
	return 0
end

function Skill_PCheck103202101(caster, skillno, actarg)
	return 0
end

function Skill_Begin103202101(caster, kSkillDef, actarg)
end

function Skill_End103202101(caster, kSkillDef, actarg)
end
