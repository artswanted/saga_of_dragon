...
-- 법사 내려찍기 패시브 스킬
function Skill_Passive103101501(unit, skillno, actarg)
	return 0
end

function Skill_PCheck103101501(caster, skillno, actarg)
	return 0
end

function Skill_Begin103101501(caster, kSkillDef, actarg)
end

function Skill_End103101501(caster, kSkillDef, actarg)
end
