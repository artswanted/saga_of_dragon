...
-- 투사 대쉬강타 패시브
function Skill_Passive101103001(unit, skillno, actarg)
	return 0
end

function Skill_PCheck101103001(caster, skillno, actarg)
	return 0
end

function Skill_Begin101103001(caster, kSkillDef, actarg)
end

function Skill_End101103001(caster, kSkillDef, actarg)
end
