...
-- 보쓰 
function Skill_Begin900000011(caster, skillnum, iStatus,arg)
	return Skill_BeginDefault(caster, skillnum, iStatus,arg)
end

function Skill_Fire900000011(caster, kTargetArray, skillnum, result, arg)
...
function Skill_Fail900000011(caster, kTargetArray, skillnum, result, arg)
	return false
end
