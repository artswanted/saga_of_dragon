...
-- 도둑 다운조작 3타 패시브
function Skill_Passive103201601(unit, skillno, actarg)
	return 0
end

function Skill_PCheck103201601(caster, skillno, actarg)
	return 0
end

function Skill_Begin103201601(caster, kSkillDef, actarg)
end

function Skill_End103201601(caster, kSkillDef, actarg)
end
