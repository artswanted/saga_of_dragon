...
-- 메이지 더블샷 패시브
function Skill_Passive103101901(unit, skillno, actarg)
	return 0
end

function Skill_PCheck103101901(caster, skillno, actarg)
	return 0
end

function Skill_Begin103101901(caster, kSkillDef, actarg)
end

function Skill_End103101901(caster, kSkillDef, actarg)
end
