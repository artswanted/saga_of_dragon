...
-- 법사 다운조작 3타 패시브 스킬
function Skill_Passive103101301(unit, skillno, actarg)
	return 0
end

function Skill_PCheck103101301(caster, skillno, actarg)
	return 0
end

function Skill_Begin103101301(caster, kSkillDef, actarg)
end

function Skill_End103101301(caster, kSkillDef, actarg)
end
