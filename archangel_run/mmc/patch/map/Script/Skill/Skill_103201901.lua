...
-- 도둑 띄우기 패시브
function Skill_Passive103201901(unit, skillno, actarg)
	return 0
end

function Skill_PCheck103201901(caster, skillno, actarg)
	return 0
end

function Skill_Begin103201901(caster, kSkillDef, actarg)
end

function Skill_End103201901(caster, kSkillDef, actarg)
end
