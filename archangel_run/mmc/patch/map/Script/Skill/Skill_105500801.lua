...
function Skill_Begin105500801(caster, skillnum, iStatus,arg)
	return Skill_BeginDefault(caster, skillnum, iStatus,arg)
end

function Skill_Toggle105500801(caster, skillnum, bToggleOn, arg)
	InfoLog(9, "Skill_Toggle105500801 --")
	local kSkillDef = GetSkillDef(skillnum)
	if kSkillDef:IsNil() then
		InfoLog(6, "Skill_Toggle105500801....SkillDef is NIl" ..skillnum)
		return -1
	end
	-- Toggle Skill
	if bToggleOn==true then
		InfoLog(9, "Skill_Toggle105500801 Add")
...
--[[
function Skill_Fire105500801(caster, kTargetArray, skillnum, result, arg)
	local bReturn = GetSkillResult106400201(caster, kTargetArray, skillnum, result)

	local kSkillDef = GetSkillDef(skillnum)
	if kSkillDef:IsNil() then
		InfoLog(5, "Skill_Fire105500801....SkillDef is NIl" ..skillnum)
		return -1
	end
...
function Skill_Fail105500801(caster, kTargetArray, skillnum, result, arg)
	local iIndex = 0
