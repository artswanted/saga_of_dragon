...
-- 궁수 다운조작 3타 패시브
function Skill_Passive102102501(unit, skillno, actarg)
	return 0
end

function Skill_PCheck102102501(caster, skillno, actarg)
	return 0
end

function Skill_Begin102102501(caster, kSkillDef, actarg)
end

function Skill_End102102501(caster, kSkillDef, actarg)
end
