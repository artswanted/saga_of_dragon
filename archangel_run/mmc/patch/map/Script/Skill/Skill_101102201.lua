...
-- 전사 찌르기 패시브 스킬
function Skill_Passive101102201(unit, skillno, actarg)
	return 0
end

function Skill_PCheck101102201(caster, skillno, actarg)
	return 0
end

function Skill_Begin101102201(caster, kSkillDef, actarg)
end

function Skill_End101102201(caster, kSkillDef, actarg)
end
