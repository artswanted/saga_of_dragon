...
-- 궁수 내려찍기 패시브
function Skill_Passive102102601(unit, skillno, actarg)
	return 0
end

function Skill_PCheck102102601(caster, skillno, actarg)
	return 0
end

function Skill_Begin102102601(caster, kSkillDef, actarg)
end

function Skill_End102102601(caster, kSkillDef, actarg)
end
