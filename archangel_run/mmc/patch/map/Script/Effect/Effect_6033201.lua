...
function Effect_Begin6033201(lavalon, iEffectNo, actarg)
	return Effect_Begin6000900(lavalon, iEffectNo, actarg)
end

function Effect_End6033201(lavalon, iEffectNo, actarg)
	return Effect_End6000900(lavalon, iEffectNo, actarg)
end

function Effect_Tick6033201(lavalon, elapsedtime, effect, actarg)
