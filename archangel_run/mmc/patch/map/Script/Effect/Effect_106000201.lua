...
function Effect_Begin106000201(unit, iEffectNo, actarg)
	return 1
end
                                                                                                                          
function Effect_End106000201(unit, iEffectNo, actarg)
	return 1
end

function Effect_Tick106000201(unit, elapsedtime, effect, actarg)
	--InfoLog(6, "Don't call me Effect_Tick105000201 Effect=" .. effect:GetEffectNo())
	--InfoLog(9, "Effect_Tick106000201 --")
	...
	if kPartyGuid:IsNil() == true then
		...
		return ECT_TICKBREAK	-- Tick break
	end
