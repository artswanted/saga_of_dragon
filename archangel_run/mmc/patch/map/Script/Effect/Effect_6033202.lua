...
function Effect_Begin6033202(lavalon, iEffectNo, actarg)
	return Effect_Begin6000900(lavalon, iEffectNo, actarg)
end

function Effect_End6033202(lavalon, iEffectNo, actarg)
	return Effect_End6000900(lavalon, iEffectNo, actarg)
end

function Effect_Tick6033202(lavalon, elapsedtime, effect, actarg)
