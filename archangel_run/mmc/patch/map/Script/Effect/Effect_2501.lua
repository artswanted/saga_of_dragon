...
-- 몬스터 거미 독 살포 (Venom) se_poison : Level 1
function Effect_Begin2501(unit, iEffectNo, actarg)
	return 1
end

function Effect_End2501(unit, iEffectNo, actarg)
	return 1
end

function Effect_Tick2501(unit, elapsedtime, effect, actarg)
	...
	local iNew = iHP + iDec
	InfoLog(9, "Effect_Tick2501 iHP:" .. iHP .. ", iDec:" .. iDec)
