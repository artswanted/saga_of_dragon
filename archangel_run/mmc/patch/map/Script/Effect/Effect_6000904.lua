...
function Effect_Begin6000904(lavalon, iEffectNo, actarg)
	return Effect_Begin6000900(lavalon, iEffectNo, actarg)
end

function Effect_End6000904(lavalon, iEffectNo, actarg)
	return Effect_End6000900(lavalon, iEffectNo, actarg)
end

function Effect_Tick6000904(lavalon, elapsedtime, effect, actarg)
