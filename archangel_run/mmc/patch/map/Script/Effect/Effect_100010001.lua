...
-- 공통 : 출혈
function Effect_Begin100010001(unit, iEffectNo, actarg)
	local kEffectMgr = unit:GetEffectMgr()
	local kEffect = kEffectMgr:GetEffect(iEffectNo, false)
	if kEffect:IsNil() == true then
		InfoLog(5, "Effect_Begin100010001...Cannot GetEffect(" .. iEffectNo ..")");
		return 0
	end
	-- MaxHP 감소
...
function Effect_End100010001(unit, iEffectNo, actarg)
	local kEffectMgr = unit:GetEffectMgr()
	local kEffect = kEffectMgr:GetEffect(iEffectNo, false)
	if kEffect:IsNil() == true then
		InfoLog(5, "Effect_End100010001...Cannot GetEffect(" .. iEffectNo ..")");
		return 0
	end
	-- MaxHP 감소
	local iAdd = kEffect:GetAbil(AT_R_MAX_HP)
...
function Effect_Tick100010001(unit, elapsedtime, effect, actarg)
	--InfoLog(6, "Don't call me Effect_Tick100010001 Effect=" .. effect:GetEffectNo())
