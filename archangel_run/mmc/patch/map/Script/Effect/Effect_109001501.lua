...
function Effect_Begin109001501(unit, iEffectNo, actarg)
...
function Effect_End109001501(unit, iEffectNo, actarg)
	--local kEffectMgr = unit:GetEffectMgr()
	--local kEffect = kEffectMgr:GetEffect(iEffectNo, false)
	--if kEffect:IsNil() == true then
...
function Effect_Tick109001501(unit, elapsedtime, effect, actarg)
	--InfoLog(6, "Don't call me Effect_Tick109001501 Effect=" .. effect:GetEffectNo())
	...
	InfoLog(9, "Effect_Tick109001501 DecHP:" .. iDecHP .. ", NewHP:" .. iNewHP)
	InfoLog(9, "Effect_Tick109001501 DecMP:" .. iDecMP .. ", NewMP:" .. iNewMP)
