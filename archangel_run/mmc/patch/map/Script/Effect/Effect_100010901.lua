...
-- 공통 : 석화
function Effect_Begin100010901(unit, iEffectNo, actarg)
	
	local kEffectMgr = unit:GetEffectMgr()
	local kEffect = kEffectMgr:GetEffect(iEffectNo, false)
	if kEffect:IsNil() == true then
		InfoLog(5, "Effect_Begin100010901...Cannot GetEffect(" .. iEffectNo ..")");
		return 0
	end
...
function Effect_End100010901(unit, iEffectNo, actarg)
	local kEffectMgr = unit:GetEffectMgr()
	local kEffect = kEffectMgr:GetEffect(iEffectNo, false)
	if kEffect:IsNil() == true then
		InfoLog(5, "Effect_Begin100010901...Cannot GetEffect(" .. iEffectNo ..")");
...
function Effect_Tick100010901(unit, elapsedtime, effect, actarg)
	InfoLog(6, "Don't call me Effect_Tick100010901 Effect=" .. effect:GetEffectNo())
	return ECT_DOTICK	
end
